#!/usr/bin/env python3
"""
Direct Tmux Voice Bot with HTTPS - Types commands directly into Claude tmux session
"""
...
<body>
    <div class="container">
        ...
        <div class="warning" id="httpsWarning" style="display: none;">
            ⚠️ Using self-signed certificate. Click "Advanced" and "Proceed" to continue.
        </div>
    ...
    <script>
        ...
        function addMessage(text) {
            ...
            message.innerHTML = `<strong>🗣️ [${timestamp}] Voice Command:</strong><br>${text}`;
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🎙️  CLAUDE DIRECT VOICE CONTROL (HTTPS)")
    print("="*60)
    print("✅ Direct tmux integration ready with HTTPS!")
    print("")
    print("📱 Access at: https://192.168.40.232:8097")
    print("")
    print("🎯 How it works:")
    print("   1. Accept the self-signed certificate warning")
    print("   2. Click the microphone button")
    print("   3. Allow microphone access")
    print("   4. Speak your command")
    print("   5. It will be typed directly into Claude!")
    print("")
    print("⚠️  Certificate Warning:")
    print("   - Click 'Advanced' in your browser")
    print("   - Then click 'Proceed to 192.168.40.232 (unsafe)'")
    print("   - This is safe - it's your own server!")
    print("="*60 + "\n")
    ...
    app.run(host='0.0.0.0', port=8097, debug=False, ssl_context=context)