#!/usr/bin/env python3
"""
Multi-Tab Claude Voice Assistant with Stats Panel - Original Working Version
"""
    ...
    <div class="main-container">
        ...
        <div class="content-container">
            ...
            <div class="main-card">
                ...
                <div class="info">
                    4 permanent sessions • Real-time voice interaction
                </div>
            </div>
        </div>
    </div>
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🎙️ MULTI-TAB CLAUDE VOICE ASSISTANT - ORIGINAL")
    print("="*60)
    print("✨ Features:")
    print("  - 4 tabs automatically created")
    print("  - Real-time stats panel (TIME/TOKENS)")
    print("  - Tab renaming via double-click")
    print("  - Stats update for active tab only")
    print("")
    print("📱 Access at: http://192.168.40.232:8404")
    print("="*60 + "\n")
    
    socketio.run(app, host='0.0.0.0', port=8404, allow_unsafe_werkzeug=True)