#!/usr/bin/env python3
"""
Orchestrator using pipe-based Claude wrapper
"""
import json
import time
import uuid
...
import threading
import queue
from claude_pipe_wrapper import pipe_orchestrator
...
class SimpleOrchestrator:
    """
    Orchestrator that uses pipe-based Claude wrapper
    """
    ...
    def __init__(self):
        ...
        print(f"[ORCHESTRATOR] Initialized with pipe wrapper")
    ...
    def create_session(self, tab_id: str, project_name: str) -> BotSession:
        ...
        try:
            # Use pipe orchestrator to create the actual Claude session
            session_id = pipe_orchestrator.create_session(tab_id)
    ...
    def route_message(self, tab_id: str, message: str) -> str:
        ...
        # Send message using pipe orchestrator
        response = pipe_orchestrator.send_message(tab_id, message)
    ...
    def cleanup_session(self, tab_id: str):
        ...
        # Clean up pipe session
        pipe_orchestrator.cleanup_session(tab_id)
